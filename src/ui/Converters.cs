...
// “全部”伪分类（Id = -1）隐藏行内重命名/删除按钮
internal sealed class CategoryButtonsVisibilityConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        return value is long id && id == -1 ? Visibility.Collapsed : Visibility.Visible;
    }
